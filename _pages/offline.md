...
<section class="landing-section landing-section--alt">
  <div class="container">
    <div class="section-header">
      ...
      <p class="section-subtitle">Two complete assignments with student submissions showcasing single-file grading, multi-file grading, and batch grading.</p>
    </div>
    <div class="tryit-card">
      <div class="tryit-icon">📦</div>
      <h3>Example Course (ZIP)</h3>
      <ul class="tryit-contents">
        <li><span class="tryit-file-icon">📄</span> Assignment handouts (PDF)</li>
        <li><span class="tryit-file-icon">⚙️</span> Course configuration (.agrx)</li>
        <li><span class="tryit-file-icon">🐍</span> Single-file assignment - solution comparison and data file import</li>
