...
<section class="landing-section">
  <div class="container">
    ...
    <div class="dl-card">
      ...
      <p class="dl-companion-link dl-companion-disabled">
        ⚙️ Server Config Template <span class="coming-soon-inline">Coming Soon</span>
      </p>
    </div>
  </div>
</section>
...
<section class="landing-section landing-section--alt">
  <div class="container">
    <div class="section-header">
      <div class="section-eyebrow">Try It Out</div>
      <h2 class="section-title">See What an Assignment Looks Like</h2>
      <p class="section-subtitle">Download a ready-made example with the assignment PDF, grading config, solution, and test data.</p>
    </div>
    <div class="tryit-card">
      <div class="tryit-icon">📦</div>
      <h3>Example Assignment (ZIP)</h3>
      <ul class="tryit-contents">
        <li><span class="tryit-file-icon">📄</span> Assignment handout (PDF)</li>
        <li><span class="tryit-file-icon">⚙️</span> Grading configuration (.agrx)</li>
        <li><span class="tryit-file-icon">🐍</span> Example solution (solution.py)</li>
        <li><span class="tryit-file-icon">📊</span> Sample data file (data.csv)</li>
      </ul>
