  ...
  <div class="container">
    <div class="about-bio">
      ...
      <div class="about-bio-text">
        <h3>Jesse Sestito</h3>
        <div class="about-bio-role">Engineering Professor, Valparaiso University</div>
        <p>
          I am a mechanical engineering professor at Valparaiso University with research interests
          in computational materials science, machine learning, and engineering education. My work
          involves developing surrogate models for biodegradable scaffold design and applying
          optimization methods to structure-property relationships in porous biomaterials.
        </p>
        <p>
          ...
          they demonstrate understanding. The autograder is central to making that workflow
          practical at scale without requiring a paid platform or cloud infrastructure.
        </p>
        <p>
          The project is open source and actively maintained. I use it in my own courses every
          semester, which means the features reflect real classroom needs rather than
  ...
  <div class="container">
    ...
    <div class="about-principles">
      <div class="about-principle">
        <div class="about-principle-icon">💰</div>
        <h3>Free. Always.</h3>
        <p>
      ...
      <div class="about-principle">
        <div class="about-principle-icon">🖥️</div>
        <h3>Real Skills</h3>
        <p>
  ...
  <div class="container">
    ...
    <div class="about-mastery">
      <p>
        ...
        The core idea is that students learn more effectively when they receive immediate,
        specific feedback and can iterate until they demonstrate understanding, rather than
        submitting once and receiving a grade days later.
      </p>
      <p>
